...
class point_cloud_generator():
    ...
    def __init__(self, rgb_file, depth_file, pc_file, focal_length,
                 scalingfactor):
    ...
    def write_ply(self):
        ...
        for i in self.df.T:
            points.append("{} {} {} {} {} {} 0\n".format(
                float_formatter(i[0]), float_formatter(i[1]),
                float_formatter(i[2]), int(i[3]), int(i[4]), int(i[5])))
...
a = point_cloud_generator('01446_colors.png',
                          '01446_depth.png',
                          '01446_3d.ply',
                          focal_length=300,
                          scalingfactor=1000)
